...
epochs_list = [10, 50, 100, 200, 300, 500]
f1_scores = []
...
for epochs in epochs_list:
    ...
    with torch.no_grad():
        ...
        f1_scores.append(f1)
        print(f"Epochs: {epochs}, F1-score: {f1:.4f}")

plt.figure(figsize=(8, 5))
plt.plot(epochs_list, f1_scores, marker='o', color='orange')
plt.title("F1-score vs. Number of Training Epochs")
plt.xlabel("Epochs")
plt.ylabel("F1-score")
plt.grid(True)
plt.savefig("epochs_analysis.png")
plt.show()
